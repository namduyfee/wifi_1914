...
#define FW_VERSION  "191222.02"
#define HW_VERSION  "191222"
...
// gpio mới
#define GPIO_BUTTON_SET_BIT_MASK     (1ULL << 13)
#define GPIO_BUTTON_UP_BIT_MASK      (1ULL << 12)
#define GPIO_BUTTON_DOWN_BIT_MASK    (1ULL << 14)

#define GPIO_LED_SET_BIT_MASK        (1ULL << 0)
#define GPIO_LED_COT_BIT_MASK        (1ULL << 2)
#define GPIO_LED_TIA_BIT_MASK        (1ULL << 15)
